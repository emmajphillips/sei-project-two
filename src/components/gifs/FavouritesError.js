    ...
    <section className="section favourites-error">
      <div className="container">
        <div className="content has-text-centered">
          ...
          <img
            src="https://media3.giphy.com/media/YrBRYRDN4M5ryrNOND/giphy.gif?cid=cf3075e27d9bda1929f42c02bfddf095c9a60c08bd3a23b4&rid=giphy.gif"
            alt="gif making whoops face"
          />
        </div>
      </div>
    </section>
